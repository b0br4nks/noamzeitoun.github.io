const lines = [
  ...
  "",
  "",
  "We provide security consulting focused on secure architecture, automation security, and system auditing.",
  "",
  "Services include network inspection, threat and malware analysis, OSINT, and actionable technical guidance.",
  "",
  "Our approach combines advisory insight with hands-on support to enhance system resilience and compliance.",
  "",
  "",
